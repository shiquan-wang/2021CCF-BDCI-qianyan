...
batch_size = 50  # 训练时每个batch中的样本数
patience = 5  # 早停轮数
file_name = 'testB_ernie_all_data_17_tta'#'baseline_testA'  # 指定输出文件的名字
...
test_input = '/home/2020/wangshiquan/work20/competiion/21bdci/data/test_B_1118.tsv'  # 完成预处理的测试集集载入路径
random_seed = 42  # 随机种子
submit_path = './submit/test_prob/'
output_path = './output/'
trained_model_path = '/home/2020/wangshiquan/work20/competiion/21bdci/torch_base/model_save/ernie_baseline_all_databest_17.bin'
...
logger.info('model_name : {}'.format(trained_model_path))
...
oof_test += test_preds_fold #/5  fold 数
